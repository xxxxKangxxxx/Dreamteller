...
SHOTS=(
  ...
  "3|03-interpret.png|상징·심리·무의식<br>세 관점의 해석|하나의 꿈을 세 가지 시선으로 깊이 풀어내,<br>오늘의 나를 돌아보게 해줘요."
  "4|05-insights.png|별빛으로 돌아보는<br>꿈의 순간|잠든 사이의 이야기가 별이 되어 떠오르는<br>감성적인 자기 성찰."
