...
### 문서 정리
- **[`docs/appstore/REVIEW_PLAYBOOK.md`](./appstore/REVIEW_PLAYBOOK.md) 신설** ⭐ — 6/22~8/11 심사 전 과정을 재사용 가능한 플레이북으로. 타임라인 / 1차 반려 5개 사유와 4.3(b)에서 통한 논리 / 2.1(b) 원인 분석 / 31일 정체 대응 판단 기준 / Apple 소통 채널 지도 / 영문 답장 톤 원칙 7개 / 함정 모음 / 다음 앱 사전 예방 체크리스트. **다음 앱·다음 심사 때 이 문서만 읽으면 되도록** 구성
- `IMPROVEMENTS.md` 갱신 (커밋 `b5197d7`) — 스냅샷·§0 재구성, Gemini 1-1/1-1a/1-1b, SSL 1-7 정정 후 해소, EC2 스왑 1-8 신설, support 도메인 메일 항목 확장, §5에 심사 노하우 4건 추가
